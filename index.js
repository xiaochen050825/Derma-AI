...
app.post('/api/clinics', async (req, res) => {
    try {
        ...
        const prompt = `
            ...
            The user is currently at Latitude: ${lat}, Longitude: ${lng}.
            ...
            - For the mapsUrl, use the format: "https://www.google.com/maps/search/?api=1&query=CLINIC_NAME+ADDRESS" (URL-encode spaces as +).
            - Do NOT estimate distances.
            
            Return ONLY a valid JSON object with a "clinics" key containing an array:
            {
              "clinics": [
                {
                  "name": "Clinic Full Name",
                  "address": "Full street address, City, State",
                  "mapsUrl": "https://www.google.com/maps/search/?api=1&query=Clinic+Full+Name+City"
                }
              ]
            }
        `;
